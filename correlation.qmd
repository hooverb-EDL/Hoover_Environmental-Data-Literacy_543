...
strongest_pair_index <- which.max(abs(cor_matrix))

# Extract the variable names for the strongest correlation
strongest_var1 <- colnames(cor_matrix)[strongest_pair_index[1]]
strongest_var2 <- colnames(cor_matrix)[strongest_pair_index[2]]

# Get the correlation value between these two variables
strongest_corr_value <- cor_matrix[strongest_pair_index]
...
hist(data_subset$AirTempF, main="Histogram of AirTempF", xlab="Air Temperature (F)", col="skyblue", border="white")

# Histogram for BP_HG
hist(data_subset$BP_HG, main="Histogram of BP_HG", xlab="Barometric Pressure (Hg)", col="lightgreen", border="white")

# Q-Q plot for AirTempF
qqnorm(data_subset$AirTempF, main="Q-Q plot for AirTempF")
qqline(data_subset$AirTempF, col = "red")

# Q-Q plot for BP_HG
qqnorm(data_subset$BP_HG, main="Q-Q plot for BP_HG")
qqline(data_subset$BP_HG, col = "red")
