...
ggplot(ntu_data, aes(x = Turbidity_Binned, 
                     fill = Treatment)) +
  geom_bar(position = "dodge", 
           color = "black", 
           size = 0.5) +
  labs(title = "Turbidity Distribution by Treatment",
       x = "Turbidity (NTU Binned)",
       y = "Frequency") +
    scale_fill_manual(values = c("Treatment A" = "lightblue", "Treatment B" = "darksalmon")) 
...
plot(data$GPA, data$GRE, 
     main = "Scatter plot of GPA vs. GRE", 
...
ggplot(data, aes(x = Treatment, y = Seeds, fill = Treatment)) +
  geom_boxplot() +
